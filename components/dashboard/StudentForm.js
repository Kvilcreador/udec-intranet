    ...
    const handleSubmit = async (e) => {
        ...
        if (formData.name && formData.matricula && formData.career && formData.antecedents) {
            ...
            try {
                ...
                console.error(error);
                alert('No se pudo guardar: ' + error.message + '\n\nSi usa bloqueador de anuncios, desactívelo para este sitio.');
            } finally {
        ...
        <div className="bg-card p-6 rounded-lg shadow-sm border mb-8">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <button
                    ...
                    className={`w-full py-3 rounded-md font-bold text-white transition-all flex items-center justify-center gap-2
